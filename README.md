...
with $u_m$ and $\nabla u$ are the temperature and its gradient values concerning the $m$ movement of the nozzle. $u_g$ is the desired temperature on particular sub-area of the printing area.
